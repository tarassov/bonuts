class Deal < ApplicationRecord
  ...
  has_many :withdrawl_operations, -> { where(direction: -1) }, class_name: "AccountOperation", dependent: :destroy
  has_many :deposit_operations, -> { where(direction: 1) }, class_name: "AccountOperation", dependent: :destroy
