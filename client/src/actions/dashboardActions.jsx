...
export function sendPoints(amount, from_profile_id, profile_ids,comment, is_for_distrib, share_for_all, burn_old, to_self_account) {
  return function(dispatch) {
    const options = {
      useToken: true,
      action: 'send',
      ...
      args:[amount, from_profile_id, profile_ids,comment,is_for_distrib,share_for_all, burn_old,to_self_account],
    }
    return commonActions.callApi(
      dispatch,options).then(json => {
