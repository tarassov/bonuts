...
ActiveRecord::Schema[7.0].define(version: 2024_04_17_112551) do
  ...
  create_table "tenant_daily_job_logs", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["tenant_id"], name: "index_tenant_daily_job_logs_on_tenant_id"
  end
  ...
  create_table "tenants", force: :cascade do |t|
    ...
    t.integer "join_to_company_points"
    t.integer "join_to_project_points"
    t.string "birthday_message"
  end
