...
RSpec.describe("api/v1/profiles_controller", type: :request) do
  ...
  path "/profiles" do
    get "get all active tenant profiles" do
      ...
      produces "application/json"
      parameter name: :tenant, in: :query, type: :string
      parameter name: :show_balance, in: :query, type: :boolean, required: false
      parameter name: :show_score, in: :query, type: :boolean, required: false
      parameter name: :show_sent, in: :query, type: :boolean, required: false
