  ...
  factory :quiz do
    ...
    factory :quiz_with_questions do
      ...
      after(:create) do |quiz, evaluator|
        create_list(:quiz_question, evaluator.questions_count / 2, quiz:, deal: quiz.deal)
        create_list(:quiz_question_with_options, evaluator.questions_count / 2, quiz:, deal: quiz.deal)
      end
    end
  end
end
