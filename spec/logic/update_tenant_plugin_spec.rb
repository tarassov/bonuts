...
describe UpdateTenantPlugin do
  ...
  context 'when user not admin' do
    before do
      ...
      @resultNotAdmin = UpdateTenantPlugin.call({ plugin_id: @plugin.id, profile: @profileNotAdmin, active: true,
  ...
  context 'when success' do
    before do
      @resultNotAdmin = UpdateTenantPlugin.call({ plugin_id: @plugin.id, profile: @profileAdmin, active: true,
                                                  tenant_settings: @tenant_settings })
    end
