...
describe AddUser do
  ...
  context 'when success' do
    before do
      ...
      @result_success = AddUser.call({ profile: @profileAdmin, tenant: @tenant, email: 'test@mail.com', password: '123',
                                       first_name: 'John', last_name: 'Snow', invited: true })
    end
  ...
  context 'when fails' do
    before do
      ...
      @result_fail = AddUser.call({ profile: @profileAdmin, tenant: @tenant, email: taken_email, password: '123',
